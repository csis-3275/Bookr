...
public class ReservationTest {
	...
	public void reservationTest() {
		...
		// Setting start date
         ...
         nr.set_start_date(dateFormat.format(date));
         
        // Setting end date
		 Calendar cal2 = Calendar.getInstance();
		 cal2.set(2019, Calendar.JULY, 26, 10, 10, 20);
		 Date date2 = cal2.getTime();
		 nr.set_end_date(dateFormat.format(date2));
		...
		assertEquals("2019-07-25", nr.get_start_date());
		...
		nr.set_end_date(dateFormat.format(date3));
        nr.set_start_date(dateFormat.format(date3));
        
		cal.set(2019, Calendar.JULY, 10, 01, 10, 20);
		Date date4 = cal.getTime();
		nr.set_end_date(dateFormat.format(date4));
        nr.set_end_date(dateFormat.format(date4));
		...
		assertEquals("2019-06-30", nr.get_start_date());
		assertEquals("2019-07-10", nr.get_end_date());
